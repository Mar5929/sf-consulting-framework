...
const SFLifecycleData = (() => {
  ...
  const toolMap = {
    ...
    'develop':             ['sf-develop', 'SFDX CLI', 'SF DX MCP', 'Context7', 'VS Code', 'COMPONENT_MANIFEST.yaml', 'Metadata Reference Templates'],
    'code-review':         ['Code Review Plugin', 'Superpowers', 'sf-develop (doc sync)'],
    ...
    'triage':              ['Linear MCP'],
    'fix-test':            ['sf-develop', 'SFDX CLI', 'SF DX MCP', 'Playwright MCP'],
