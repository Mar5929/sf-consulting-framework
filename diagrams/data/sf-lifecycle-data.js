...
const SFLifecycleData = (() => {
  ...
  const nodes = [
    ...
    { id: 'integration-design',name: 'Integration\nDesign',     phase: 'phase-design', category: 'process',  description: 'API design, MuleSoft flows, event-driven architecture.',                     x: 7, shape: 'rect' },
    { id: 'design-review',     name: 'Design Review',           phase: 'phase-design', category: 'process',  description: 'Review solution design with technical leads and stakeholders.',               x: 8, shape: 'rect' },
    { id: 'approved',          name: 'Approved?',               phase: 'phase-design', category: 'decision', description: 'Is the design approved by stakeholders and technical review board?',          x: 9, shape: 'diamond' },

    // Build phase
    { id: 'sprint-plan',       name: 'Sprint Planning',         phase: 'phase-build', category: 'process',  description: 'Plan sprint backlog, assign stories, estimate effort.',                       x: 10, shape: 'rect' },
    { id: 'develop',           name: 'Develop\n(Apex/LWC/Config)', phase: 'phase-build', category: 'process',  description: 'Write Apex classes, LWC components, declarative configuration.',         x: 11, shape: 'rect' },
    { id: 'code-review',       name: 'Code Review',             phase: 'phase-build', category: 'process',  description: 'Peer review of Apex, LWC, and configuration changes.',                      x: 12, shape: 'rect' },
    { id: 'sprint-demo',       name: 'Sprint Demo',             phase: 'phase-build', category: 'process',  description: 'Demo completed work to stakeholders for feedback.',                          x: 13, shape: 'rect' },
    { id: 'sprint-complete',   name: 'Sprint\nComplete?',       phase: 'phase-build', category: 'decision', description: 'Is the sprint scope complete and accepted?',                                 x: 14, shape: 'diamond' },

    // Test phase
    { id: 'unit-tests',        name: 'Unit Tests',              phase: 'phase-test', category: 'process',  description: 'Apex unit tests with 75%+ code coverage requirement.',                       x: 15, shape: 'rect' },
    { id: 'integration-tests', name: 'Integration\nTests',      phase: 'phase-test', category: 'process',  description: 'End-to-end integration testing across systems.',                              x: 16, shape: 'rect' },
    { id: 'uat',               name: 'UAT',                     phase: 'phase-test', category: 'process',  description: 'User Acceptance Testing with business users in sandbox.',                     x: 17, shape: 'rect' },
    { id: 'defect-resolution', name: 'Defect\nResolution',      phase: 'phase-test', category: 'process',  description: 'Fix defects found during testing, re-validate.',                              x: 18, shape: 'rect' },
    { id: 'tests-pass',        name: 'All Tests\nPass?',        phase: 'phase-test', category: 'decision', description: 'Do all unit, integration, and UAT tests pass?',                               x: 19, shape: 'diamond' },

    // Deploy phase
    { id: 'pre-deploy',        name: 'Pre-Deploy\nChecklist',   phase: 'phase-deploy', category: 'process',  description: 'Run pre-deployment checklist: metadata, data, permissions.',               x: 20, shape: 'rect' },
    { id: 'deploy-staging',    name: 'Deploy to\nStaging',      phase: 'phase-deploy', category: 'process',  description: 'Deploy validated package to staging/UAT sandbox.',                          x: 21, shape: 'rect' },
    { id: 'smoke-test',        name: 'Smoke Test',              phase: 'phase-deploy', category: 'process',  description: 'Quick validation of critical paths in staging environment.',                x: 22, shape: 'rect' },
    { id: 'prod-deploy',       name: 'Production\nDeploy',      phase: 'phase-deploy', category: 'process',  description: 'Deploy to production with change management approval.',                     x: 23, shape: 'rect' },
    { id: 'go-live',           name: 'Go-Live',                 phase: 'phase-deploy', category: 'process',  description: 'Production go-live, user cutover, hypercare period begins.',                x: 24, shape: 'rect' },

    // Managed Services phase
    { id: 'receive-ticket',    name: 'Receive Ticket',          phase: 'phase-managed', category: 'process',  description: 'Inbound support ticket from client via Linear or email.',                 x: 25, shape: 'rect' },
    { id: 'triage',            name: 'Triage &\nAssign',        phase: 'phase-managed', category: 'process',  description: 'Assess priority, assign to team member, set SLA timer.',                  x: 26, shape: 'rect' },
    { id: 'fix-test',          name: 'Fix & Test',              phase: 'phase-managed', category: 'process',  description: 'Implement fix, test in sandbox, validate resolution.',                    x: 27, shape: 'rect' },
    { id: 'deploy-fix',        name: 'Deploy Fix',              phase: 'phase-managed', category: 'process',  description: 'Deploy fix to production through CI/CD pipeline.',                       x: 28, shape: 'rect' },
    { id: 'close-ticket',      name: 'Close Ticket',            phase: 'phase-managed', category: 'process',  description: 'Confirm resolution with client, close ticket, update SLA metrics.',      x: 29, shape: 'rect' },
  ];
  ...
  const edges = [
    ...
    { source: 'data-model',         target: 'integration-design' },
  ...
  const toolMap = {
    ...
    'solution-arch':       ['Context7 MCP', 'drawio skill', 'Well-Architected guidance'],
    ...
    'develop':             ['SFDX CLI', 'SF DX MCP', 'Context7', 'VS Code'],
